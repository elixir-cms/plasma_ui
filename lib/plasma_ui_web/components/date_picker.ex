defmodule PlasmaUiWeb.Components.DatePicker do
  ...
  def render(assigns) do
    ~F"""
    <div class="date-picker" id="{@fieldName}-picker" :hook="DatePicker">
      <svg
        class="calendar-icon w-6 h-6"
        fill="black"
        viewBox="0 0 20 20"
      ...
      <input
        ...
        value={@value}
      />
      <input class="flatpickr" default-date={@value} phx-update="ignore" type="text">
    </div>
    """
  end
end
